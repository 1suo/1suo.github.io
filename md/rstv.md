...
### Сравнения с другими раскладками
Синтетическая раскладка пользователя lemosbor, еще более лоупноповая. Подходит только для клавиатур с полноценной боковой колонкой для левого мизинца -- на него приходится 6 букв. Зато, если отзеркалить ее по горизонтали, она поместится на обычную клавиатуру. Правда, для angle-mod придется жертвовать пнопами, и левая рука будет перегружена.
Пунктуация не входит в раскладку, но статистику это сильно не ухудшает. 
Для полного счастья нужно сместить положения букв (и, а, ь) -> (ь, и, а).  
